...
\[ P\_{SIT}(s) = \frac{0.9204}{1.0507 s + 1} \, e^{-0.1371 s} \]
...
en la identificación de los instantes en los que la respuesta alcanza el 25 % y
el 75 % de su valor final, a partir de los cuales se estiman los parámetros del
modelo.

El modelo obtenido corresponde a:

\[ P\_{123c}(s) = \frac{0.9215}{0.9887 s + 1} \, e^{-0.1923 s} \]
...
\[ P\_{Ho}(s) = \frac{0.9215}{1.0653 s + 1} \, e^{-0.1484 s} \]
...
\[ P\_{LS}(z) = \frac{0.01895 z^{-1}}{1 - 0.9796 z^{-1}} \]
