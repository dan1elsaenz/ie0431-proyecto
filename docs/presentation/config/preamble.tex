...
\usepackage{import}   % para el comando \import{...}{...}
\usepackage{float}    % para el modificador [H] en las figuras

\usepackage{xifthen}  % usado en algunos .pdf_tex de Inkscape
\usepackage{svg}      % si usas el entorno/funciones de svg
...
% % \usepackage{efbox,graphicx}
 ...
 %% Couleurs
  ...
  %% Hyperliens
  \hypersetup{%
    pdfauthor = {Daniel Sáenz},
    pdftitle = {Funcionamiento y Usos del LiDAR},
    colorlinks = false,
    linktocpage = true,
    urlcolor = blue,
    linkcolor = black,
...
% Número de página mostrado = framenumber + 1
\newcommand{\shownframenumber}{\number\numexpr\insertframenumber\relax}

\setbeamertemplate{footline}{%
	\leavevmode%
	\hfill
	\usebeamerfont{footline}\usebeamercolor[fg]{footline}%
	\scriptsize \shownframenumber/\inserttotalframenumber\hspace{0.5cm}
	\vskip2pt
}